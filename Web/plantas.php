                  ...
                  <div class="gestion-plantas">
                    ...
                    <div class="contenedor-finca-huertos-plantas" id="contenedor-finca-huertos-plantas">
                      ...
                      <div class="contenedor-anadir-seleccion">
                        ...
                        <div class="contenedor-mensaje-confirmacion" id="mensaje-confirmacion">
                          <div class="mensaje-confirmacion">
                            <div class="contenedor-confirmacion">
                              <div id="titulo-confirmacion"></div>
                              <div id="texto-confirmacion"><b>Ha realizado una selección múltiple.</b></br>Se borrarán todos los estados asociados a las plantas seleccionadas</br><text>¿Desea continuar?</text></div>
                              <div class="botones-confirmacion">
                                <div class="fila-botones">
                                  <input id="boton-confirmar-confirmacion" name="boton-cancelar-confirmacion" type="submit" value="OK" onclick="accion_boton_gestionar();"></input>
                                  <input id="boton-cancelar-confirmacion" name="boton-cancelar-confirmacion" type="submit" value="CANCELAR" onclick="accion_ocultar_confirmacion();"></input>
                                </div>
                              </div>
                            </div>
                          </div>
