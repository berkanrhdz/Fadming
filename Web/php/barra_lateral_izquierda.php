	...
	if ($tipo == CLIENTE_EMPRESA) {
		if ($rol == ADMINISTRADOR) {
			echo "<div class='fila-acceso' id='empresa'>" .
							"<a href='empresas.php'><div id='icono-empresa'></div><div class='nombre-acceso' id='texto-empresa'>Empresa</div></a>" .
					 "</div>" .
					 "<div class='fila-acceso' id='usuario'>" .
					 		"<a href='usuarios.php'><div id='icono-usuario'></div><div class='nombre-acceso' id='texto-usuario'>Usuarios</div></a>" .
					 "</div>" .
