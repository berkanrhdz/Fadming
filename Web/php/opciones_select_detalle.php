<?php
  ...
  $tipo = $_SESSION['tipo'];
	...
	if ($tipo == CLIENTE_EMPRESA) {
		...
		echo "<option value='4'>Cantidad de estados realizados por usuario</option>";
		echo "<option value='5'>Cantidad de plantas por finca en...</option>";
		echo "<option value='6'>Cantidad de plantas por huerto en...</option>";
	}
